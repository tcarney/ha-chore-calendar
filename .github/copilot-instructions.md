...
- **Main code:** `custom_components/chore_calendar/`
...
- `entity/` — Base entity class (`ChoreCalendarEntity`)
...
- Debug level: `custom_components.chore_calendar: debug` in `config/configuration.yaml`
