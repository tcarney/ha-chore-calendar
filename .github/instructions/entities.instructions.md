...
- **`entity/`** - Base entity classes (inherit `ChoreCalendarEntity` from `entity/base.py`)
...
**MUST inherit from:** `(PlatformEntity, ChoreCalendarEntity)` - order matters for MRO
...
**Imports pattern:** `from homeassistant.components.PLATFORM import PlatformEntity, PlatformEntityDescription` + `from ..entity import ChoreCalendarEntity`
