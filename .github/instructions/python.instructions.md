...
- Files: `snake_case.py`
- Classes: `PascalCase` prefixed with `ChoreCalendar`
...
- Inherit from both platform entity and `ChoreCalendarEntity` (order matters)
...
from custom_components.chore_calendar.sensor import async_setup_entry
...
**Config entry data:** `entry_data: ChoreCalendarData = hass.data[DOMAIN][entry.entry_id]`
