...
- `ChoreCalendarApiClientError` (Base)
- `ChoreCalendarApiClientCommunicationError` (Network, timeout, HTTP errors)
- `ChoreCalendarApiClientAuthenticationError` (401, 403, invalid credentials)
