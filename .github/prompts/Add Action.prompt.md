...
**File:** `custom_components/chore_calendar/services.yaml`
...
Create `custom_components/chore_calendar/service_actions/[action_name].py`:

```python
"""[Action name] service action for Chore Calendar."""
...
**File:** `custom_components/chore_calendar/__init__.py`
...
**File:** `custom_components/chore_calendar/const.py`
...
3. Find service action: `chore_calendar.[action_name]`
...
- **Service actions directory:** `custom_components/chore_calendar/service_actions/` (preferred) or `actions/`
- **Service actions definition:** `custom_components/chore_calendar/services.yaml` (legacy filename)
- **Icons:** `custom_components/chore_calendar/icons.json` under `services` key (legacy)
- **Translations:** `custom_components/chore_calendar/translations/*.json` under `services` key (legacy)
