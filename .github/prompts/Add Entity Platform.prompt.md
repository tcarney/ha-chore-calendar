...
**Directory:** `custom_components/chore_calendar/[platform]/`
...
```python
"""[Platform] platform for Chore Calendar."""
...
from .entity import ChoreCalendarEntity
from .[entity_file] import ChoreCalendar[EntityName]
from .const import DOMAIN
from .coordinator import ChoreCalendarDataUpdateCoordinator
...
async def async_setup_entry(
    ...
    coordinator: ChoreCalendarDataUpdateCoordinator = hass.data[DOMAIN][
        entry.entry_id
    ]

    async_add_entities(
        [
            ChoreCalendar[EntityName](coordinator, entry),
...
```python
"""[Entity description] for Chore Calendar."""
...
class ChoreCalendar[EntityName](
    ChoreCalendarEntity,
    [PlatformEntityClass],
):
    ...
    def __init__(
        self,
        coordinator: ChoreCalendarDataUpdateCoordinator,
        entry: ConfigEntry,
    ) -> None:
...
Add platform to `custom_components/chore_calendar/manifest.json`:
...
- [ ] Entity class inherits from both `ChoreCalendarEntity` and platform class
...
- **Class prefix:** `ChoreCalendar`
- **Base entity:** `ChoreCalendarEntity` in `entity/base.py`
- **Coordinator:** `ChoreCalendarDataUpdateCoordinator`
