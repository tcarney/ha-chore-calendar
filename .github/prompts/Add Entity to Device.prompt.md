...
- Inherit from `ChoreCalendarEntity` and platform base class
...
- Entity: `custom_components/chore_calendar/[platform]/[entity_name].py`
- Platform: `custom_components/chore_calendar/[platform]/__init__.py`
