...
- Create new sensor file in `custom_components/chore_calendar/sensor/`
- Inherit from `ChoreCalendarEntity` and `SensorEntity`
...
```python
"""[Sensor description] for Chore Calendar."""
...
class ChoreCalendar[SensorName]Sensor(
    ChoreCalendarEntity,
    SensorEntity,
):
...
- Entity: `custom_components/chore_calendar/sensor/[sensor_name].py`
- Platform: `custom_components/chore_calendar/sensor/__init__.py`
- Translations: `custom_components/chore_calendar/translations/*.json`
