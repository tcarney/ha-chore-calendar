/**
 * Action handler directive for tap, hold, and double-tap gestures.
 * Adapted from lovelace-mushroom / home-assistant-frontend.
 */
...
class ActionHandler extends HTMLElement implements ActionHandlerType {
  ...
  public bind(
    ...
    if (
      ...
      JSON.stringify(options) === JSON.stringify(element.actionHandler.options)
    ) {
      return;
    }
